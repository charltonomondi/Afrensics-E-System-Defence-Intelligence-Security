...
import { Shield, Search, Users, AlertTriangle, Cloud, GraduationCap, Database, Settings, FileText, Monitor, Lock, UserCheck, Smartphone, Code, Brain, Cpu } from 'lucide-react';
...
const services = [
  {
    ...
    features: ["Smart Automation", "Predictive Analytics", "AI Agents", "Machine Learning", "Business Intelligence"],
    popular: true
  },
  {
            ...
            {services.map((service, index) => (
              <Card key={index} className={`relative card-gradient shadow-card hover:shadow-hero transition-all duration-300 hover:-translate-y-1 ${service.popular ? 'ring-2 ring-primary' : ''}`}>
                ...
                <CardHeader className="text-center">
                  ...
                  <div className="text-lg font-semibold text-primary mb-4">Contact for pricing</div>
                </CardHeader>
                <CardContent>
