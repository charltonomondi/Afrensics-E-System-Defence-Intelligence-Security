...
import BiloHubAIPopup from "@/components/BiloHubAIPopup";
import CookieConsent from "@/components/CookieConsent";
import { usePenetrationTestingPopup } from "@/hooks/usePenetrationTestingPopup";
import { useBiloHubAIPopup } from "@/hooks/useBiloHubAIPopup";
...
import BiloHubAI from "./pages/BiloHubAI";

const queryClient = new QueryClient();

const App = () => {
  const { isPopupOpen, closePopup } = usePenetrationTestingPopup();
  const { isPopupOpen: isBiloHubOpen, closePopup: closeBiloHub } = useBiloHubAIPopup();
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route path="/bilohub-ai" element={<BiloHubAI />} />
          ...
          {/* BiloHub AI Popup */}
          <BiloHubAIPopup
            isOpen={isBiloHubOpen}
            onClose={closeBiloHub}
          />
