...
const heroSlides: HeroSlide[] = [
  {
    title: "BiloHub",
    subtitle: "AI for African Business",
    description: "Empowering African businesses with cutting-edge artificial intelligence. Smart automation, predictive analytics, and intelligent solutions.",
    ctaText: "Discover BiloHub AI",
  ...
  },
  {
    ...
    description: "Protect your business with comprehensive cybersecurity solutions tailored for modern enterprises. AI-powered threat detection.",
